...
-- DROP VIEW Lista_Actor_Pelicula;
...
ON AP1.Cantidad = AP2.ValorMaximo;
...
-- Creamos el conjunto A: Peliculas que ha participado UMA WOOD

CREATE VIEW Conjunto_A AS
SELECT * FROM Actor_Pelicula
WHERE ap_id_actor = 13;
-- Creamos el conjunto B: Toda la lista de actores menos UMA WOOD

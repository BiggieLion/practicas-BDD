...
SELECT COUNT(*) FROM S; -- Verificamos que son 70 peliculas
...
/*Creacion de un procedimiento almacenado para la division de conjuntos*/
...
-- Probamos nuestro procedimiento almacenado
CALL Division(13);